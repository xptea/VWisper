  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Test and practice with VWisper transcription. Try speaking while holding Right CTRL key on Windows & Linux and the control key on Mac.
        </CardDescription>
      </CardHeader>
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                placeholder={isRecording ? "🎤 Listening... Release Right CTRL key on Windows & Linux and the control key on Mac when done." : "Click here and hold Right CTRL key on Windows & Linux and the control key on Mac to start transcribing. Your speech will appear as text in real-time."}
                readOnly={false}
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <span>Press and hold the Right CTRL key on Windows & Linux and the control key on Mac</span>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center mt-0.5">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <span>Let go of Right CTRL key on Windows & Linux and the control key on Mac when you're finished speaking</span>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center mt-0.5">
